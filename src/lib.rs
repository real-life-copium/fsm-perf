...
pub mod fsm {
    ...
    static STATES: [[State; 13]; 8] = [
        [
            Hour1, Hour1, Hour2, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd,
            Error, Error, Error,
        ],
        [
            HourEnd, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd, HourEnd,
            HourEnd, Delim, Error, Error,
        ],
        [
            HourEnd, HourEnd, HourEnd, HourEnd, Error, Error, Error, Error, Error, Error, Delim,
            Error, Error,
        ],
        [
            Error, Error, Error, Error, Error, Error, Error, Error, Error, Error, Delim, Error,
            Error,
        ],
        [
            Minute, Minute, Minute, Minute, Minute, Minute, MinuteEnd, MinuteEnd, MinuteEnd,
            MinuteEnd, Error, Error, Error,
        ],
        [
            MinuteEnd, MinuteEnd, MinuteEnd, MinuteEnd, MinuteEnd, MinuteEnd, MinuteEnd, MinuteEnd,
            MinuteEnd, MinuteEnd, Error, Error, Match,
        ],
        [
            Hour1, Hour1, Hour2, Error, Error, Error, Error, Error, Error, Error, Error, Error,
            Match,
        ],
        [
